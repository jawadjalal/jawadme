...
export function profileMarkdown(): string {
  ...
  return [
    ...
    "## hiring him",
    "",
    `${link("design studio", `${IDENTITY.site}/design`)} — brand identity, ui/ux and full site builds. ` +
...
export function llmsTxt(): string {
  ...
  return [
    ...
    `- ${link("design studio", `${IDENTITY.site}/design`)}: what he takes on, what it costs, and a brief form`,
